<template >
  <div style="text-align:center;width:1000px;margin-left: 250px;">
    <el-header style="height: 60px;">
        <span style="font-size:30px">更新医院资料</span>&nbsp;&nbsp;&nbsp;&nbsp;
    </el-header>
  ...
  export default {
    ...
    created(){
        this.axios.post(this.Global.basePath+'getHospitalByHAdminPhone',{
          ...
          .then((res) => {
            this.ruleForm.valueCity=res.data.hCity,
            this.ruleForm.inputName=res.data.hName,
            this.ruleForm.inputAdminPhone=res.data.hAdminPhone,
            this.ruleForm.inputPhone=res.data.hPhoneNum,
            this.ruleForm.inputPass=res.data.hAdminPassword,
            this.ruleForm.inputAddress=res.data.hAddress,
            this.ruleForm.inputBus=res.data.hBus,
            this.ruleForm.inputContent=res.data.hContent,
            this.ruleForm.hId=res.data.hId
          })
