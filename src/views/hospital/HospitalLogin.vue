    ...
    <el-container>
            ...
            <el-container>
              <div id="LoginBackground">
                  ...
                  <h1 style="font-size: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;医院管理者登录</h1>
...
export default {
    ...
    methods: {
      login(data){
        this.axios.post(this.Global.basePath+'loginHospital', {
            hAdminPhone:data.phone,
            hAdminPassword:data.pass
          })
          .then((res) => {
            if (res.data==1) {
              alert("登录成功！");
