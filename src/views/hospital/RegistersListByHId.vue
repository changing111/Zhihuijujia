  ...
  <div >
    <el-header style="height: 100px;white-space: nowrap;  /*强制span不换行*/
      ...
      <div style="height: 70px;">
        ...
        <span>&nbsp;&nbsp;挂号日期:</span>
        <el-date-picker value-format="yyyy-MM-dd" type="date"  placeholder="选择日期" v-model="inputDate"></el-date-picker>
    ...
    <el-main style="height: 650px;">
        <el-table :data="tableData" style="width: 100%" height="600px">
          ...
          <el-table-column prop="regDate" value-format="yyyy-MM-dd" label="挂号日期" width="240">
          </el-table-column>           
        </el-table>
    </el-main>
