    ...
    <el-header style="height: 50px;">
      <div style="height: 50px;">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/Doctor' }" style="font-size:20px">{{this.oName}}-医生列表</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/Remain' }" style="font-size:20px">{{this.dName}}医生-余号表</el-breadcrumb-item>
