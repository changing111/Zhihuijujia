  ...
  <div >
      ...
      line-height: 0.9;  /*数字与之前的文字对齐*/">
        <div style="height: 50px;">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item style="font-size:20px">服务币变更纪录</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
        <span>&nbsp;&nbsp;变更原因:</span>
        <el-select v-model="valueReason" placeholder="请选择变更原因">
          <el-option
            v-for="item in this.Global.BalanceRecordReasons"
    ...
    <el-main style="height: 640px;">
        <el-table :data="tableData" style="width: 100%" height="600px">
            <el-table-column prop="bId" label="序号" width="150" sortable>
            </el-table-column>
            <el-table-column prop="bName" label="用户" width="220">
            </el-table-column>
            <el-table-column prop="bPhoneNum" label="用户手机号" width="200">
            </el-table-column>
            <el-table-column prop="bReason" label="变更原因" width="220">
            </el-table-column>
            ...
            <el-table-column prop="bTime" label="交易时间" width="220" sortable>
            </el-table-column>
        </el-table>
    </el-main>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      keywordSerach(){
        this.axios.post(this.Global.basePath+'getBalanceRecordsListByInputLike',{
          currentPage:this.currentPage,
          pageSize:this.pageSize,
