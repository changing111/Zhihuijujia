  ...
  <div >
    <el-header style="height: 100px;white-space: nowrap;  /*强制span不换行*/
      ...
      <div style="height: 50px;">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item style="font-size:20px">您的历史志愿活动</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
        <span>&nbsp;&nbsp;活动状态:</span>
    ...
    <el-main style="height: 640px;">
        <el-table :data="tableData" style="width: 100%" height="600px">
            <el-table-column prop="vaName" label="活动内容" width="180">
            </el-table-column>
            <el-table-column prop="vaVsName" label="所属义工站" width="230">
            </el-table-column>
            <el-table-column prop="vaHourNum" label="服务时长/小时" width="200">
            </el-table-column>
            <el-table-column prop="vaTime" label="活动开始时间" width="200">
            </el-table-column>
            <el-table-column prop="vaState" label="活动状态" width="250">
            </el-table-column>
            <el-table-column prop="vaRemSum" label="所需义工数" width="250">
            </el-table-column>
            <el-table-column prop="vaRemNum" label="已报义工数" width="250">
            </el-table-column>
        </el-table>
    </el-main>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      conditionSerach(){
        this.axios.post(this.Global.basePath+'getVolActivitysListByEPhoneAndCondition',{
          currentPage:this.currentPage,
          pageSize:this.pageSize,
          volActivity:{ 
            vaEPhoneNum:sessionStorage.getItem("uId"),
      ...
      keywordSerach(){
        this.axios.post(this.Global.basePath+'getVolActivitysListByEPhoneAndInputLike',{
          currentPage:this.currentPage,
          pageSize:this.pageSize,
          volActivity:{ 
            vaEPhoneNum:sessionStorage.getItem("uId"),
            vaEName:this.inputLike,
          }
        })
          .then((res) => {
            this.tableData = res.data.volActivitysList
