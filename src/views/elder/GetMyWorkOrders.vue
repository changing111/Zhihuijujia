    ...
    <el-header style="height: 100px;white-space: nowrap;  /*强制span不换行*/
      ...
      <div style="height: 50px;">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item style="font-size:20px">您的历史工单</el-breadcrumb-item>
        </el-breadcrumb>
    ...
    <el-main style="height: 650px;">
        <el-table :data="tableData" height="500px">
            <el-table-column prop="wId" label="单号" width="130" sortable>
              ...
              <el-table-column prop="wSName" label="商户名称" width="180" >
              </el-table-column>
              <el-table-column prop="wSName" label="商户手机号" width="180" >
              </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      conditionSerach(){
        this.axios.post(this.Global.basePath+'getWorkOrdersListByEPhoneAndCondition',{  //该接口也可以用于长者
      ...
      keywordSerach(){
        this.axios.post(this.Global.basePath+'getWorkOrdersListByEPhoneAndInputLike',{
          currentPage:this.currentPage,
          pageSize:this.pageSize,
          workOrder:{ 
            wEPhoneNum:sessionStorage.getItem("uId"),
