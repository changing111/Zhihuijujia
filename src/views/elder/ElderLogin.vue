    ...
    <el-container>
            ...
            <el-container>
              <div id="LoginBackground">
                  ...
                  <h1 style="font-size: 30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;长者登录</h1>
...
export default {
    ...
    methods: {
      login(data){
        this.axios.post(this.Global.basePath+'loginElder', {
            ePhoneNum:data.phone,
            ePassword:data.pass
          })
          .then((res) => {
            if (res.data==1) {
              ...
              this.$router.push({name:'ElderIndex'})
            } else {
              alert("手机号或密码错误！")
            }
          })
