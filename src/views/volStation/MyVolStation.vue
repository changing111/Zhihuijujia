<template >
  <div style="text-align:center;width:1000px;margin-left: 250px;">
    <el-header style="height: 60px;">
        <span style="font-size:30px">更新义工站资料</span>&nbsp;&nbsp;&nbsp;&nbsp;
    </el-header>
  ...
  export default {
    ...
    created() {
        this.axios.post(this.Global.basePath+'getVolStationByVsAdminPhone',{
          ...
          .then((res) => {
            this.ruleForm.valueCity=res.data.vsCity,
            this.ruleForm.inputName=res.data.vsName,
            this.ruleForm.inputHostCard=res.data.vsHostCard,
            this.ruleForm.inputPhone=res.data.vsAdminPhone,
            this.ruleForm.inputPass=res.data.vsAdminPass,
            this.ruleForm.inputAddress=res.data.vsAddress,
            this.ruleForm.inputHostName=res.data.vsAdminName,
            this.ruleForm.vsId=res.data.vsId
          })
